...
My general interests reside in deep learning, the training of neural networks, cognitive science, and the applications in computer vision and natural language processing. During my PhD, I focused mainly on two fields of deep learning training: distributed learning, where operations are parallelized on several machines, and local learning, a more biologically plausible approach to gradient estimation.
